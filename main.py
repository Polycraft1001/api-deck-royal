...
API_TOKEN = os.environ.get('eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiIsImtpZCI6IjI4YTMxOGY3LTAwMDAtYTFlYi03ZmExLTJjNzQzM2M2Y2NhNSJ9..wIFwZ3aAzNml1PVPp34YYYsMF2xFGWSQi5iPunlyWla5CVBtcvVqVLNfIKYOVbFdu6s3MbBsQF3n8uhrWIeHBg')
if not API_TOKEN:
    raise ValueError("Le token API Clash Royale n'est pas défini dans les variables d'environnement !")
